...
app.post("/generate", async (req, res) => {
  ...
  try {
    ...
    const modelIdentifier = "adirik/realvisxl-v3.0-turbo"; // <-- ¡CAMBIO AQUÍ!
    const modelVersion = "3dc73c805b11b4b01a60555e532fd3ab3f0e60d26f6584d9b8ba7e1b95858243"; // <-- ¡CAMBIO AQUÍ!
